...
{
    public float minSpeed = 1f;  // Minimum speed for driving sound
    public float maxSpeed = 100f; // Maximum speed for pitch scaling
    private float currentSpeed;

    private Rigidbody carRb;
    private AudioSource carAudio; // Engine sound source
    public AudioSource idleAudio; // Idle sound source (attach another AudioSource for idle sound)

    public float minPitch = 0.5f; // Minimum pitch for low speed
    public float maxPitch = 2f;   // Maximum pitch for high speed
    private float pitchFromCar;

    public float movementThreshold = 0.1f; // Speed threshold to consider the vehicle moving
